...
#information on any variable can be accessed like this:
#attribute(ff_sub_orig$var_name)
#attributes(ff_sub_orig$k5g2h)
```

<!-- changed how plots for items were being created, and moved it folder named R for the app. -->
