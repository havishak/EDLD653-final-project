...
We are using data from the Fragile Families & Child Well-Being Study (Princeton) for this project. The study is longitudinal, with data collected from child participants, their parents/guardians, and their teachers at multiple time points (e.g., Baseline, Year 9, Year 15). More information about the study can be found [here](https://fragilefamilies.princeton.edu/documentation) and the data can be accessed [here](https://fragilefamilies.princeton.edu/data-and-documentation/public-data-documentation )

> The above formatting lets you use hyperlinks in a markdown file - it may be useful for streamlining the writeup if you want to show it to more people :)
- 
- 
...
> Your code for filtering and selecting items within the (meta)dataset makes really good use of the %in%, &, and | operators - very clean, efficient, and easy to read!
...
> Manipulating metadata is really difficult for me to wrap my head around and you all do a great job here!
...
> I'm not 100% sure I know what this code is doing, but if you're having difficulty with assignment inside a loop, I've had great success with the assign() function from base R - it may solve your map2 problem.
...
> Bill Revelle's [psych package](http://personality-project.org/r/psych/) has some very user-friendly tools for reverse coding and manipulating scales - it may be worth checking out to help simplify the above code
...
> This is a really well written function!
