...
by_ethrace %>% 
    ...
    geom_col()
```
#Parallell interations for scatterplots
```{r}
ff_sub_lm1 <- ff_sub_lm %>% 
  select( int_scores, ext_scores, cm1bsex, ck6ethrace, del_beh_9, del_beh_15, p5l12g, p6c21)
...
scatter1 <- function(df, DV, IV, group) {
 ...
 p = df %>% 
  ...
  ifelse(var2 == "ff_sub_lm1$int_scores",
        p <- p + labs(title = "Delinquent Behaviour at 15 predicted by Internalizing scores at 9"),
 ifelse (var2 == "ff_sub_lm1$ext_scores",
      p <- p + labs(title = "Delinquent Behaviour at 15 predicted by Externalizing scores at 9"),
      p <- p))
...
#Del. Behaviour at 15 by Internalizing scores at 9, grouped by Race
scatter1(ff_sub_lm1, ff_sub_lm1$del_beh_15, ff_sub_lm1$int_scores, ff_sub_lm1$ck6ethrace)

#Del. Behaviour at 15 by Internalizing scores at 9, grouped by Gender
scatter1(ff_sub_lm1, ff_sub_lm1$del_beh_15, ff_sub_lm1$int_scores, ff_sub_lm1$cm1bsex)

#Del. Behaviour at 15 by Externalizing scores at 9, grouped by Race
scatter1(ff_sub_lm1, ff_sub_lm1$del_beh_15, ff_sub_lm1$ext_scores, ff_sub_lm1$ck6ethrace)

#Del. Behaviour at 15 by Externalizing scores at 9, grouped by Gender
scatter1(ff_sub_lm1, ff_sub_lm1$del_beh_15, ff_sub_lm1$ext_scores, ff_sub_lm1$cm1bsex)



#Plots for both internatlizing and externalizing behavior grouped by gender
map(ff_sub_lm1[1:2],
